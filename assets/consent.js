...
(function () {
  ...
  var I18N = {
    de: {
      ...
      marketing: 'Marketing',
      marketingDesc: 'Messung von Werbung und Reichweite (Google Ads, TikTok, Meta).',
    ...
    es: {
      ...
      marketing: 'Marketing',
      marketingDesc: 'Medición de publicidad y alcance (Google Ads, TikTok, Meta).',
    ...
    en: {
      ...
      marketing: 'Marketing',
      marketingDesc: 'Advertising and reach measurement (Google Ads, TikTok, Meta).',
  ...
  function applyConsent(consent) {
    ...
    // Etiquetas de marketing (TikTok + Meta Pixel) — solo con consentimiento de marketing/ads
  ...
  /* ---------- Meta Pixel (Facebook/Instagram) — SOLO con consentimiento de marketing ---------- */
