...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "El peor enemigo del aceite es la luz. La lata bloquea toda la luz y el oxígeno, así que el aceite llega a tu mesa como recién molturado. Y el aluminio es ligero, irrompible y 100% reciclable.": "Light is olive oil's worst enemy. The tin blocks all light and oxygen, so the oil reaches your table as if just milled. And aluminium is light, unbreakable and 100% recyclable.",
    ...
    de: {
      ...
      "El peor enemigo del aceite es la luz. La lata bloquea toda la luz y el oxígeno, así que el aceite llega a tu mesa como recién molturado. Y el aluminio es ligero, irrompible y 100% reciclable.": "Licht ist der größte Feind des Öls. Die Dose hält alles Licht und Sauerstoff ab, damit das Öl frisch wie eben gemahlen bei dir ankommt. Und Aluminium ist leicht, unzerbrechlich und zu 100% recycelbar.",
