...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "Elige un uso y descubre dónde brilla AURO, recién abierto y en frío.": "Pick a use and discover where AURO shines, freshly opened and cold.",
      "Tostadas": "Toast",
      "Ensaladas": "Salads",
      "A la brasa": "Grilled",
      "Cremas": "Soups",
      "Chorro final": "Finishing drizzle",
      "Un hilo en crudo al salir de la brasa realza el punto y perfuma el plato.": "A raw drizzle straight off the grill lifts the sear and perfumes the dish.",
      "Corona un hummus o una crema de verduras: textura sedosa y un final vivo.": "Finish a hummus or vegetable soup: silky texture and a lively edge.",
      "Fuera del fuego, un buen chorro final da brillo, aroma y cuerpo.": "Off the heat, a good final drizzle adds shine, aroma and body.",
      "Sobre un queso curado o fresco: contraste de amargor noble y untuosidad.": "Over cured or fresh cheese: a contrast of noble bitterness and richness.",
      "El gesto que lo cambia todo: un hilo en crudo justo antes de servir.": "The move that changes everything: a raw drizzle just before serving.",
      ...
      "Análisis": "Analysis",
      "Ficha de la cosecha 2026": "2026 harvest data sheet",
      "Antioxidantes naturales. Saludable ya por encima de 250.": "Natural antioxidants. Already healthy above 250.",
      "Muy por debajo del límite del AOVE (≤0,8%).": "Well below the EVOO limit (≤0.8%).",
    ...
    de: {
      ...
      "Elige un uso y descubre dónde brilla AURO, recién abierto y en frío.": "Wähle eine Verwendung und entdecke, wo AURO glänzt — frisch geöffnet und kalt.",
      "Tostadas": "Brot",
      "Ensaladas": "Salate",
      "A la brasa": "Vom Grill",
      "Cremas": "Cremesuppen",
      "Chorro final": "Schuss zum Schluss",
      "Un hilo en crudo al salir de la brasa realza el punto y perfuma el plato.": "Ein roher Spritzer direkt vom Grill hebt die Röstaromen und parfümiert das Gericht.",
      "Corona un hummus o una crema de verduras: textura sedosa y un final vivo.": "Verfeinere Hummus oder Gemüsecremesuppe: seidige Textur und ein lebendiger Abgang.",
      "Fuera del fuego, un buen chorro final da brillo, aroma y cuerpo.": "Vom Herd genommen sorgt ein guter letzter Schuss für Glanz, Aroma und Körper.",
      "Sobre un queso curado o fresco: contraste de amargor noble y untuosidad.": "Über gereiftem oder frischem Käse: Kontrast aus edler Bitterkeit und Fülle.",
      "El gesto que lo cambia todo: un hilo en crudo justo antes de servir.": "Der Handgriff, der alles verändert: ein roher Spritzer kurz vor dem Servieren.",
      ...
      "Análisis": "Analyse",
      "Ficha de la cosecha 2026": "Datenblatt der Ernte 2026",
      "Antioxidantes naturales. Saludable ya por encima de 250.": "Natürliche Antioxidantien. Bereits ab 250 gesund.",
      "Muy por debajo del límite del AOVE (≤0,8%).": "Weit unter dem Grenzwert für natives Öl extra (≤0,8%).",
